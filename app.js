...
<body>
  ...
  <div class="versionBadge">VERSIONE 2026-02-21 16:20 (INLINE CSS)</div>
    ...
    <div class="snap" id="snap">
      ...
      <section class="screen" id="gift">
        <div class="card pageShell">
          ...
          <p class="pageText">
            Celebrare insieme questo giorno sarà per noi il dono più bello.<br><br>
            Se desiderate contribuire ai nostri progetti futuri, potete farlo cliccando sull’icona.
          </p>
      ...
      <section class="screen" id="photos">
        <div class="card pageShell">
          ...
          <p class="pageText">Cliccando sull’icona qui sotto, potrete caricare i vostri scatti.</p>
  ...
  <script src="./app.js?v=20260221-1620"></script>
</body>
</html>
